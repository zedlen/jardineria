...
<div id="container">
	<h1>Jardinera</h1>
	<p>Productos dsiponibles:<br>
		<a href="<?php echo base_url();?>index.php/welcome/addProduct" class='btn btn-primary btn-sm'>Agregar <i class='fa fa-plus' aria-hidden='true'></i></a></p>
	<?php
		$this->db->select("*");
